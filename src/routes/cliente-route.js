const { adicionarProdCarrinho, atualizarCliente, atualizarImageCliente, cadastro, cadastroView, carrinhoView, contaUsuario,deleteOneProdCarrinhoId, deleteCliente, index, login, loginView } = require('../controllers/cliente-controller')
